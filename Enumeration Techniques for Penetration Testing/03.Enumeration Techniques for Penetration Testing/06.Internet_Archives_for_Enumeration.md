...
- 🛡️ Organizations auditing their attack surface

# Internet Archives – URL & Subdomain Enumeration

A collection of **passive reconnaissance techniques** for extracting historical URLs and discovering subdomains using Internet Archive–based tools.
...
- **VirusTotal** – URLs observed via malware and threat-intelligence feeds
