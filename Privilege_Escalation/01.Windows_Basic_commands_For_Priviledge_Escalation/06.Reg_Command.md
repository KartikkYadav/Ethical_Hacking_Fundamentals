...
- Windows-Registry — registry structure, hives, and editing concepts — related note
- Windows-Advanced-Boot-Options — LastKnownGood and boot-related registry keys — related note
- WMIC-Commands — WMI/CLI queries that complement registry inspection — related note
