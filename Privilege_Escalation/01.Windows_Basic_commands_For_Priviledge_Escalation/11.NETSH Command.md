...
- Windows-Firewall-and-AV-Commands — Defender Firewall and AV command reference — related note
- Network-Enumeration — host and network reconnaissance from the CLI — related note
