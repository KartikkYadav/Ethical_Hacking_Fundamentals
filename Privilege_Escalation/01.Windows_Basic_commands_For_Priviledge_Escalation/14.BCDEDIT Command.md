...
- Windows-Advanced-Boot-Options — related note — Safe Mode and recovery boot options BCDEDIT controls
- DISKPART-Command — related note — partition/volume management that pairs with boot repair
