...
- BCDEDIT-Command — boot configuration data editing after partitioning — related note
- Windows-Advanced-Boot-Options — recovery and boot options that depend on the active/boot partition — related note
