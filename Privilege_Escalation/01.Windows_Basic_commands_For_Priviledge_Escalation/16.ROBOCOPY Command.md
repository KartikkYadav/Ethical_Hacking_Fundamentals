...
- XCOPY-Command — related note — the older directory-copy tool ROBOCOPY supersedes
- Windows-Basic-Commands — related note — core file and directory commands including `copy`
- File-System — related note — NTFS attributes and permissions ROBOCOPY can preserve
