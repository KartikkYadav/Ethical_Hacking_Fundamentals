...
- Windows-Basic-Commands — `icacls`, `takeown`, and file management commands
- Windows-Registry — registry autorun keys used for user-level persistence
- ATTRIB-Command — file attributes on writable paths
- 8.3-Filename-(Short-File-Name).md) — short filenames and path discovery
