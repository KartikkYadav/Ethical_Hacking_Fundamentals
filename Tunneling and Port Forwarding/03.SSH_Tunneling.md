...
---<img width="1536" height="1024" alt="ChatGPT Image Jan 24, 2026, 03_36_53 PM" src="https://github.com/user-attachments/assets/9074cd7d-2f7f-4c75-8fd1-6cd34c2e27d0" />
...
- Commonly used to access services that are only reachable from the SSH server’s network.
         ...
         DC (192.168.3.250:80)                              
                │
                ▼
       LC01 (192.168.2.253 → 192.168.3.253)  
                │
                ▼
           SSH Tunnel
                │
...
### Example
    ...
    ssh -R 9090:192.168.2.233:80 debian@192.168.2.253
